...
import { SymptomeComponent } from 'app/entities/symptome/symptome.component';
...
describe('Component Tests', () => {
  describe('Symptome Management Component', () => {
    let comp: SymptomeComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SymptomeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.symptomes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
