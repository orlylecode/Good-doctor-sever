...
import io.cogitech.gooddoctor.config.audit.AuditEventConverter;
import io.cogitech.gooddoctor.domain.PersistentAuditEvent;
...
import static io.cogitech.gooddoctor.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
